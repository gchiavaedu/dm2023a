...
PARAM  <- list()
PARAM$experimento  <- "G.FE08.TS01.HT01.ZZ01.6910"
PARAM$exp_input  <- "G.FE08.TS01.HT01.6510"
...
PARAM$semillas  <- c( 108881, 262637, 541447, 678547, 848629 ) #reemplazar por las propias semillas

PARAM$kaggle$envios_desde  <-  10600L

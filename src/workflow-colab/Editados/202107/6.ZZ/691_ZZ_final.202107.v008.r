...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910.202107.v008"
PARAM$exp_input  <- "HT6510.202107.v008"
...
PARAM$semillas  <- c( 1108881, 262637, 541447, 678547, 848629,  104087, 104089, 104107, 104113, 104119 ) #reemplazar por las propias semillas

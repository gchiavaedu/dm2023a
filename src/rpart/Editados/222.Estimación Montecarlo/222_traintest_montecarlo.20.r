...
ksemillas  <- c(108881, 262637, 541447, 678547, 848629, 100049, 100151, 121721, 185303, 200177,
                235709, 322909, 422537, 422549, 434723, 522731, 524287, 686843, 883799, 959339) #reemplazar por las propias semillas

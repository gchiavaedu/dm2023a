...
PARAM  <- list()
PARAM$experimento <- "A.TS01.FE00.DR00.TS7410"

PARAM$exp_input  <- "A.FE00.DR00.FE7310"
...
PARAM$train$undersampling  <- 0.15   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

...
PARAM  <- list()
PARAM$experimento  <- "A.ZZ05.s4.HT00.TS08.FE14.DR00.ZZ7950"    #s1 hace referencia a semilla 1, para cada semilla hago uno diferente. Semillas: 108881; 262637; 541447; 678547; 848629
PARAM$exp_input  <- "A.HT00.TS08.FE14.DR00.HT7510"          
...
PARAM$semilla_primos  <- 678547  # se utiliza para generar el vector de  PARAM$semillerio  semillas

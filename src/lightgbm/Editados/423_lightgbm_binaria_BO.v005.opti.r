...
PARAM$trainingstrategy$semilla_azar   <- 108881  #Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$hs <- makeParamSet(
  ...
  makeNumericParam("lambda_l1", lower = 0.0001, upper = 100),
  makeNumericParam("lambda_l2", lower = 0.0001, upper = 100)
)

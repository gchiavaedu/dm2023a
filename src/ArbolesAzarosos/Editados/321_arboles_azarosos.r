...
PARAM$semilla  <- 108881      #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
PARAM$num_trees_max  <- 10000 #voy a generar 500 arboles, a mas arboles mas tiempo de proceso y MEJOR MODELO, pero ganancias marginales
...
grabar  <- c( 1, 5, 10, 50, 100, 200, 500, 1000, 5000, 7500, 10000)
